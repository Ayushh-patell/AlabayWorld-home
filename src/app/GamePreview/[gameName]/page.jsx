    ...
    <div className=' w-screen h-dvh overflow-hidden bg-black relative'>
      ...
      <main className=' w-full h-full px-24 py-10'>
        <div className=' w-full h-full relative z-10'>
          <h1 className=' font-baron text-white text-7xl my-6'>{GamePreviewLinkData[params.gameName].name}</h1>
          <h2 className={`${bebas.className} text-4xl tracking-[0.25em] my-5`} style={{color:`${GamePreviewLinkData[params.gameName].primaryClr}`}}>{GamePreviewLinkData[params.gameName].subname}</h2>
          <p className={`${mont.className} font-bold text-white text-lg w-1/3`}>{GamePreviewLinkData[params.gameName].desc}</p>

          <button className=' px-10 pl-4 py-3 my-7 flex justify-between items-center gap-5 rounded-full' style={{backgroundColor:`${GamePreviewLinkData[params.gameName].primaryClr}`}}>
          ...
          <h4 className={` ${mont.className} font-bold text-white text-3xl mb-5`}><span style={{color:`${GamePreviewLinkData[params.gameName].primaryClr}`}}>GAME</span> PREVIEWS</h4>
