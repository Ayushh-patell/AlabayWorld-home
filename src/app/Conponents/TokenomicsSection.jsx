  ...
  return (
    <section className=" w-full bg-white pt-10">
      ...
      <div id="tokenomicsGradient" className=" md_2:pt-20">
        ...
        <div className=" flex justify-between items-center gap-2 p-4 sm:pr-4 pr-2 md_2:pb-10 lg:pb-4">
          <div className={` md_2:w-1/2 w-[40%] flex justify-center items-center flex-col gap-7 ${mont.className} font-black lg"text-2xl sm:text-xl sm_1:text-base text-[9px]`}>
          ...
          <Image
            ...
            width={400}
            height={500}
            className=" md_2:w-[45%] w-[60%] sm:scale-100 scale-[1.2] object-contain object-center"
          />
        </div>
      </div>
