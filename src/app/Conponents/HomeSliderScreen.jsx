...
// DETECT TOUCH SWIPE FOR MOBILE
  ...
  return (
    ...
    <Image src={'/sliderfirstDog.png'} alt='dog' width={700} height={1000} className=' pointer-events-none absolute z-10 left-0 sm:top-[10%] top-[10%] md_1:w-1/2 md:w-2/3 sm_1:w-[64%] sm_2:w-3/5 w-[55%] object-contain object-center '/>
